...
class TestCard(unittest.TestCase):
    ...
    def test_q5(self):
        ...
        '''
        d2 = hw5_cards.Deck()
        self.assertIsInstance(d2.deal_card(), type(hw5_cards.Card()))
        return d2.deal_card(), type(hw5_cards.Card())
    ...
    def test_q6(self):
        ...
        d3.deal_card()
        d3_new = len(d3.cards)
        self.assertEqual(d3_old-1, d3_new)
        return d3_old-1, d3_new
    ...
    def test_q7(self):
        ...
        d4_org = len(d4.cards)
        card = d4.deal_card()
        d4_deal = len(d4.cards)
        d4.replace_card(card)
        d4_new = len(d4.cards)
        self.assertEqual(d4_deal+1, d4_new, d4_org)
        return d4_deal+1, d4_new, d4_org
