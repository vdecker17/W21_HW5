...
class TestCard(unittest.TestCase):
    ...
    def test_q5(self):
        ...
        '''
        d2 = hw5_cards.Deck()
        self.assertIsInstance(type(d2.deal_card()), type(hw5_cards.Card))
        return type(d2.deal_card), type(hw5_cards.Card)
    ...
    def test_q7(self):
        ...
        d4_new = len(d4.cards)
        self.assertEqual(d4_old, d4_new)
        return d4_old, d4_new
